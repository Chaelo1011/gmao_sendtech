                ...
                <div class="card-body">
                    <form action="{{ route('talleres.update', $taller->id) }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" id="nombre" value="{{ $taller->nombre }}" placeholder="Nombre del taller" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control @error('area') is-invalid @enderror" name="area" id="area" value="{{ $taller->area }}" placeholder="Area donde se ubica" required>
