        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header row m-0">
                    <div class="col-md-9">
                        <h4>Editar plan de mantenimiento</h4>
                    </div>
                ...
                <div class="card-body">
                    <form action="{{ route('plan_mantenimiento.update', $plan_mantenimiento->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-7">
                                <select name="id_maquina" id="id_maquina" class="form-select @error('id_maquina') is-invalid @enderror" required>
                                    ...
                                    @foreach($maquinaria as $maquina)
                                        <option value="{{$maquina->id}}" @if($maquina->id==$maquina_selected) selected @endif>{{$maquina->id." - ".$maquina->nombre." ".$maquina->marca." ".$maquina->modelo}}</option>
                                    @endforeach
                                </select>
                                    ...
                                    <select name="id-personal0" id="id-personal0" class="form-select @error('id-personal0') is-invalid @enderror personal-select" required>
                                        ...
                                        @foreach($personal as $persona)
                                            <option value="{{$persona->id}}" 
                                             @for($i=0; $i < count($personal_selected); $i++)
                                                @if(($persona->id == $personal_selected[$i]) && $find==0)
                                                    selected
                                                    <?php $find = 1; $personal_selected[$i]=false;?>
                                                @endif
                                             @endfor >
                                             {{$persona->ci." - ".$persona->nombre." ".$persona->apellido." - ".$persona->area}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-7">
                                    <select name="id-herramientas0" id="id-herramientas0" class="form-select @error('id-herramientas0') is-invalid @enderror herramientas-select" required>
                                        ...
                                        @foreach($herramientas as $herramienta)
                                            ...
                                            @for($i=0; $i < count($herramientas_selected); $i++)
                                                @if(($herramienta->id == $herramientas_selected[$i]) && $find==0)
                                                    selected
                                                    <?php $find = 1; $herramientas_selected[$i]=false;?>
                                                @endif
                                             @endfor >
                                            {{$herramienta->id." - ".$herramienta->nombre." ".$herramienta->dimensiones." ".$herramienta->dimensiones_medida." ".$herramienta->capacidad." ".$herramienta->capacidad_medida}}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="id-repuestos0" id="id-repuestos0" class="form-select @error('id-repuestos0') is-invalid @enderror repuestos-select">
                                        ...
                                        @foreach($repuestos as $repuesto)
                                            ...
                                            @for($i=0; $i < count($repuestos_selected); $i++)
                                                ...
                                                @endif
                                             @endfor >
                                            {{$repuesto->id." - ".$repuesto->nombre." ".$repuesto->dimensiones." ".$repuesto->dimensiones_medida." ".$repuesto->capacidad." ".$repuesto->capacidad_medida}}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group row">
                            <label for="fecha" class="col-md-3 col-form-label text-right">Fecha del plan</label>

                            <div class="col-md-7">
                                <input type="date" class="form-control @error('fecha') is-invalid @enderror" name="fecha" id="fecha" value="{{ $plan_mantenimiento->fecha }}" required autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <select name="tipo_mantenimiento" id="tipo_mantenimiento" class="form-select @error('tipo_mantenimiento') is-invalid @enderror" required>
                                    ...
                                    <?php $tipo = ['Preventivo', 'Correctivo', 'Predictivo']; ?>

                                    @for($i=0; $i < count($tipo); $i++)
                                        <option value="{{$tipo[$i]}}" @if($tipo[$i]==$plan_mantenimiento->tipo_mantenimiento) selected @endif >{{$tipo[$i]}}</option>
                                    @endfor
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <select name="criticidad" id="criticidad" class="form-select @error('criticidad') is-invalid @enderror" required>
                                    ...
                                    <?php $criticidad = ['Baja', 'Media', 'Alta']; ?>

                                    @for($i=0; $i < count($criticidad); $i++)
                                        <option value="{{$criticidad[$i]}}" @if($criticidad[$i]==$plan_mantenimiento->criticidad) selected @endif >{{$criticidad[$i]}}</option>
                                    @endfor
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <select name="estatus" id="estatus" class="form-select @error('estatus') is-invalid @enderror" required>
                                    ...
                                    <?php $estatus = ['Pendiente', 'Completado']; ?>

                                    @for($i=0; $i < count($estatus); $i++)
                                        <option value="{{$estatus[$i]}}" @if($estatus[$i]==$plan_mantenimiento->estatus) selected @endif >{{$estatus[$i]}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <textarea class="form-control  @error('descripcion') is-invalid @enderror" name="descripcion" id="descripcion" cols="30" rows="5" autocapitalize="on">@if(old('descripcion')) {{old('descripcion')}} @else {{$plan_mantenimiento->descripcion}} @endif</textarea>
