        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header row m-0">
                    <div class="col-md-9">
                        <h4>Registrar repuesto</h4>
                    </div>
                    <div class="col-md-3 text-right">
                        <a href="{{ route('repuestos.index') }}" class="btn btn-primary"><i class="bi bi-arrow-left"></i> Regresar</a>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <form action="{{ route('repuestos.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control @error('dimensiones') is-invalid @enderror" name="dimensiones" id="dimensiones" value="{{ old('dimensiones') }}" placeholder="Dimensiones del repuesto" pattern="[0-9.,]+" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control @error('costo_estimado') is-invalid @enderror" name="costo_estimado" id="costo_estimado" value="{{ old('costo_estimado') }}" placeholder="Costo estimado del repuesto" pattern="[0-9.,]+" autocomplete="off">
